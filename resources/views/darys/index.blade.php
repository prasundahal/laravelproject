...
<html lang="en">
  <head>
    <title>Dairy Product &mdash; Royal Group </title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(images/dary1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-12" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row mb-4">
              <div class="col-md-7">
                <h1>Dairy Product</h1>
                <p class="mb-5 lead">Lets Shop with us to take the healthy product inside your home .</p>
                <div>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-6 text-center">
            <h3 class="section-sub-title">Our dairy Products</h3>
            <h2 class="section-title mb-3">Our dairy Products</h2>
            <p>We offer you all kind of dairy product in your door step.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              ...
              <div class="px-4">
                ...
                <p class="mb-4">We offer you cow ,buffalo,Goat milk at your door step ..</p>
                <div>
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              ...
              <div class="px-4">
                ...
                <p class="mb-4">We offer you best quality Curd </p>
                <div>
                  <a href="#" class="btn btn-black mr-1 rounded-0">Cart</a>
                  <a href="#" class="btn btn-black btn-outline-black ml-1 rounded-0">View</a>
                </div>
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="images/chease.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Chease</a></h3>
                <div class="mb-3">
                  <span class="meta-icons mr-3"><a href="#" class="mr-2"><span class="icon-star text-warning"></span></a> 5.0</span>
                  <span class="meta-icons wishlist"><a href="#" class="mr-2"><span class="icon-heart"></span></a> 29</span>
                </div>
                <p class="mb-4">Our chease are the best chease fount in Nepal </p>
                <div>
                  <a href="#" class="btn btn-black mr-1 rounded-0">Cart</a>
                  <a href="#" class="btn btn-black btn-outline-black ml-1 rounded-0">View</a>
                </div>
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              ...
              <div class="px-4">
                ...
                <p class="mb-4">We offer you all kind of ghee product ....</p>
                <div>
                  <a href="#" class="btn btn-black mr-1 rounded-0">Cart</a>
                  <a href="#" class="btn btn-black btn-outline-black ml-1 rounded-0">View</a>
                </div>
